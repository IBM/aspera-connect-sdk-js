	  ...
	  return version;
		...
		this.getEnvSupportInfo = function () {
			...
			envProfiles = {
				...
				isChrome : {
				  test : (uAgent.toLowerCase().indexOf('chrome') > -1 && chromeSupportsNapapi() && !isMacIntel10_6),
				...
				macIntel10_6 : {
					...
					description : "On OS X 10.6, Aspera Connect supports 32-bit browsers, only.",
					platform : 'MacIntel',
					code: "10_6_32_bit_only",
					downloadOnly: true,
					isSupported : true
				},
...
/*
* Pre-Connect 2.8 API support for backwards compatibility
*/
ConnectInstaller = AW.ConnectInstaller;
