...
// 		// Based on data received respond below
...
// var asperaWeb3;
// 
// // Can only have one WAMP session, so just use the same AW4.Connect object.
// describe("AW4.Connect", function () {
// 	describe("with WAMP options", function () {
// 		beforeEach("Fake Connect is running", function() {
// 			asperaWeb3 = new AW4.Connect(options);
// 		});
// 
// 		// Verifies that mockServer was hit 
// 		it("should connect to WAMP", function (done) {
// 			// var asperaWeb3 = new AW4.Connect(options);
// 
// 		  // Timeout to let websocket connection establish
// 			setTimeout(() => {
// 				// Wrap in try-catch block to avoid Uncaught Assertion exception in Mocha
// 				try{
...
// 		});
// 
// 		it("should make WAMP usable", function (done) {
// 			var wampSession = new AW4.WampSession(options)
// 			sinon.spy(wampSession, "isUsable");
// 
// 			setTimeout(() => {
// 				try{
// 					expect(wampSession.isUsable()).to.equal(true);
// 					wampSession.isUsable.restore();
// 					done();
// 				}
// 				catch (e) {
// 					done(e);
...
// 		});
// 
// 		// Verifies that AW4.Connect#version hits onSuccess callback
// 		it("should use WAMP protocol for API requests", function (done) {					
// 			setTimeout(() => {  
// 				sinon.spy(wampCallback, "onSuccess")
// 				asperaWeb3.version(wampCallback);
// 			}, 100);
// 
// 			setTimeout(() => {
// 				try{
// 					expect(wampCallback.onSuccess.called).to.equal(true);
// 					wampCallback.onSuccess.restore();
// 					done();
// 				}
// 				catch (e) {
// 					done(e);
...
// 		});
// 
// 		it("should handle error responses from WAMP", function (done) {					
// 			setTimeout(() => {  
// 				sinon.spy(wampCallback, "onError")
// 				return_error = true;
// 				asperaWeb3.version(wampCallback);
// 			}, 100);
// 
// 			setTimeout(() => {
// 				try{
// 					expect(wampCallback.onError.called).to.equal(true);
// 					wampCallback.onError.restore();
// 					done();
// 				}
// 				catch (e) {
// 					done(e);
...
},{"mock-socket":1}],3:[function(require,module,exports){
