...
test('should show header', () => {
  const app = render(<TwoStepBanner currentState={props.banner} href={props.href} majorVersion={props.version} isOutdated={false} changeState={props.change}/>);
...
test('should show upgrade button if outdated', () => {
  const app = render(<TwoStepBanner currentState={props.banner} href={props.href} majorVersion={props.version} isOutdated={true} changeState={props.change}/>);
