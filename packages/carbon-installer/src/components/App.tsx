      ...
      <div lang={dict.getCurrentLanguageCode()}>
       ...
       <button
        ...
        <button
          className="ui-button"
          type="button"
          onClick={() => {window.postMessage('downloadlink=https://dwosk.gitlab.aspera.us/connect-api-test-page/dist/v4/bin/IBMAsperaConnectInstallerOneClick-3.9.9.177099.dmg', '*')}}>
          downloadlink
        </button>
        <button
          className="ui-button"
